...
class GameplayChangersSubstate extends MusicBeatSubstate
{
	...
	function getOptions()
	{
		...
		var option:GameplayOption = new GameplayOption('Stackable Health Damage', 'stackableHealthDmg', 'bool', false);
		if (ClientPrefs.newHealthSystem) optionsArray.push(option);
	}
