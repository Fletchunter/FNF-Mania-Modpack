...
class FreeplayState extends MusicBeatState
{
	...
	public static var getWeekName:String = '';
	...
	*/
	...
	override function update(elapsed:Float)
	{
		...
		var poop:String = Highscore.formatSong(songLowercase, curDifficulty, curMode);
		...
		else if(space)
		{
			if(instPlaying != curSelected)
			{
				...
				var poop:String = Highscore.formatToLoadSong(songs[curSelected].songName.toLowerCase(), curDifficulty);
				PlayState.SONG = Song.loadFromJson(getWeekName , poop, songs[curSelected].songName.toLowerCase());
		...
		else if (accepted)
		{
			...
			trace('CURRENT WEEK: ' + getWeekName);
			if(colorTween != null) {
				colorTween.cancel();
			}
	...
	function changeDiff(change:Int = 0)
	{
		...
		#if !switch
		intendedScore = Highscore.getScore(songs[curSelected].songName, curDifficulty, curMode);
		intendedRating = Highscore.getRating(songs[curSelected].songName, curDifficulty, curMode);
		#end
		PlayState.storyDifficulty = curDifficulty;
		PlayState.storyMode = curMode;
