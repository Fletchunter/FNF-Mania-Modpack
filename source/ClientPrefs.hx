...
class ClientPrefs {
	...
	public static var laneUnderlayAlpha:Float = 0.6;
	public static var darkenScreenAlpha:Float = 0.6;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.darkenScreenAlpha = darkenScreenAlpha;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.darkenScreenAlpha != null) {
			darkenScreenAlpha = FlxG.save.data.darkenScreenAlpha;
		}
