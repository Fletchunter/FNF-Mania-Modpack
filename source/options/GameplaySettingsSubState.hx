...
class GameplaySettingsSubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option('Lane Underlay Transparency',
			'How clearly should the lane underlay be displayed."',
			'laneUnderlayAlpha',
			'percent',
			0.6);
		addOption(option);
		...
		var option:Option = new Option('Darken Screen Transparency',
			'How clearly should the darken screen be displayed."',
			'darkenScreenAlpha',
			'percent',
			0.6);
		addOption(option);
